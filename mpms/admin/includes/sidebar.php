...
{               ?>
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-flask fa-fw"></i>Contact Us Queries<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-flask fa-fw"></i>Booking<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="new-booking.php">New Booking</a>
                            </li>
                            <li>
                                <a href="old-booking.php">Old Booking</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    <li>
                        <a href="search-booking.php"><i class="fa fa-search"></i>Search<span class="fa arrow"></span></a>
                         ...
                         <li>
                        <a href="#"><i class="fa fa-folder"></i>Reports<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
